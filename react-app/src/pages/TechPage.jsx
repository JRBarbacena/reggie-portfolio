...
const certificates = [
  ["cert-python.png", "Python", "Certiport", "Open the Python Information Technology Specialist certificate", "Information Technology Specialist certification in Python awarded to John Reggie Manuel Barbacena"],
  ["cert-matlab.png", "MATLAB", "LinkedIn Learning", "Open the Learning MATLAB certificate", "LinkedIn Learning MATLAB course completion certificate awarded to John Reggie Barbacena"],
  ["cert-barbacena.png", "Project Management", "PMI", "Open the PMI Project Management Ready certificate", "PMI Project Management Ready credential awarded to John Reggie Manuel Barbacena"],
  ["cert-agile.png", "Agile Development", "LinkedIn Learning", "Open the Agile Software Development certificate", "LinkedIn Learning Agile Software Development course completion certificate awarded to John Reggie Barbacena"],
];
...
export default function TechPage() {
  ...
  return <main id="main" className="content-column">
    ...
    <section className="tech-certificates" aria-labelledby="certificates-title"><SectionHead id="certificates-title" title="Learning, verified" copy="Formal checkpoints across programming, engineering practice, and project delivery." /><div className="credential-shelf">{certificates.map(([file, title, source, label, alt], index) => <a className="credential-book" href={`/images/certificates/${file}`} target="_blank" rel="noopener" aria-label={label} data-reveal data-reveal-delay={index || undefined} key={file}><figure><img src={`/images/certificates/${file}`} alt={alt} width="1584" height="1224" loading="lazy" /><figcaption><strong>{title}</strong><span>{source}</span></figcaption></figure></a>)}</div></section>
